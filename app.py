...
/* NAVBAR */
.navbar {
    width:100%; background:#1e2d40;
    display:flex; align-items:center; justify-content:space-between;
    padding:11px 36px; box-shadow:0 2px 8px rgba(0,0,0,0.18);
}
...
.search-input {
    background:#2d3f55; border:none; border-radius:8px;
    padding:7px 14px 7px 34px; color:#94a3b8; font-size:13px;
    width:160px; outline:none;
}
.nav-avatar {
    width:34px; height:34px; border-radius:50%; background:#38bdf8;
    display:flex; align-items:center; justify-content:center;
    font-weight:700; color:#1a2233; font-size:14px; flex-shrink:0;
}
.nav-username { color:#e2e8f0; font-size:14px; font-weight:500; display:flex; align-items:center; gap:4px; }
.nav-btn {
    display:flex; align-items:center; gap:6px;
    background:#2d3f55; color:#e2e8f0 !important;
...
.nav-icon-btn {
    background:#2d3f55; border-radius:8px; padding:7px 10px;
...
.hero-left { flex:1; }
.hero-title { font-size:2.1rem; font-weight:800; color:#1a2233; margin-bottom:8px; display:flex; align-items:center; gap:12px; }
...
/* SECTION TITLE */
.section-title { font-size:1.35rem; font-weight:700; color:#1a2233; margin:4px 0 18px; display:flex; align-items:center; gap:10px; }

/* STEPS */
.steps-row { display:flex; align-items:stretch; gap:0; margin-bottom:36px; overflow-x:auto; }
.step-card {
    min-width:115px; max-width:130px; background:#1e2d40;
...
.step-num { font-size:2rem; font-weight:800; color:rgba(255,255,255,0.2); line-height:1; margin-bottom:10px; position:relative; z-index:1; }
.step-text { font-size:0.75rem; color:#94a3b8; line-height:1.5; position:relative; z-index:1; }
.step-text strong { color:#e2e8f0; }
.step-arrow { display:flex; align-items:center; justify-content:center; color:#38bdf8; font-size:1.1rem; padding:0 4px; flex-shrink:0; align-self:center; }

/* MODELS */
.models-wrap { display:grid; grid-template-columns:1fr 1fr; gap:0; min-height:260px; margin-bottom:0; }
...
.model-group ul { list-style:disc; padding-left:18px; color:#334155; line-height:2.0; font-size:0.93rem; }
...
/* FOOTER */
.footer-note { font-size:0.78rem; color:#94a3b8; padding:14px 48px; border-top:1px solid #dde3ec; background:#eef2f7; }
.footer-bar { background:#1e2d40; display:flex; justify-content:space-between; align-items:center; padding:14px 48px; font-size:0.82rem; }
...
.footer-built { background:#111827; text-align:center; color:#475569; font-size:0.74rem; padding:7px; }
</style>
...
<div class="navbar">
  <div class="navbar-brand">
    ...
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
      ...
      <line x1="11.1" y1="11.1" x2="13.8" y2="13.8" stroke="#38bdf8" stroke-width="1.2" opacity="0.7"/>
      <line x1="22.2" y1="22.2" x2="24.9" y2="24.9" stroke="#38bdf8" stroke-width="1.2" opacity="0.7"/>
      <line x1="24.9" y1="11.1" x2="22.2" y2="13.8" stroke="#38bdf8" stroke-width="1.2" opacity="0.7"/>
      <line x1="13.8" y1="22.2" x2="11.1" y2="24.9" stroke="#38bdf8" stroke-width="1.2" opacity="0.7"/>
    </svg>
    <span class="navbar-title">HYPER<span>TUNEML</span></span>
  </div>
  <div class="navbar-right">
    <div class="search-wrap">
      <svg class="search-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#64748b" stroke-width="2.5">
    ...
    <a class="nav-btn" href="https://github.com/Rajneeshsharma125/ML-Model-dataset-trainer-" target="_blank">
      <!-- fork icon -->
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#e2e8f0" stroke-width="2.2" stroke-linecap="round">
    ...
    <a class="nav-icon-btn" href="https://github.com/Rajneeshsharma125" target="_blank">
      ...
      <svg width="22" height="22" viewBox="0 0 24 24" fill="#e2e8f0">
        <path d="M12 2C6.477 2 2 6.484 2 12.021c0 4.428 2.865 8.184 6.839 9.504.5.092.682-.217.682-.482
          0-.237-.009-.868-.013-1.703-2.782.605-3.369-1.342-3.369-1.342-.454-1.155-1.11-1.463-1.11-1.463
          ...
          .64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.919.678 1.852
          0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.2 22 16.447 22 12.021
          22 6.484 17.523 2 12 2z"/>
      </svg>
    </a>
  </div>
</div>
  ...
  <div class="hero-left">
    <div class="hero-title">
      ...
      <svg width="46" height="46" viewBox="0 0 46 46" fill="none">
        ...
        <circle cx="7.8" cy="7.8" r="2" fill="#1a2233" opacity="0.6"/>
        <circle cx="38.2" cy="7.8" r="2" fill="#1a2233" opacity="0.6"/>
        <circle cx="7.8" cy="38.2" r="2" fill="#1a2233" opacity="0.6"/>
        <circle cx="38.2" cy="38.2" r="2" fill="#1a2233" opacity="0.6"/>
      </svg>
      HyperTuneML Platform
    </div>
    <div class="hero-sub">
      An end-to-end Machine Learning platform — upload your data, preprocess, explore,
      train, evaluate, compare, predict, and download your model.
    </div>
  </div>
  <div class="hero-right">
    <!-- decorative neural network diagram -->
    <svg viewBox="0 0 300 190" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- floating nodes -->
      <circle cx="210" cy="22" r="6" fill="#c8d8e8" stroke="#7a98b0" stroke-width="1.2"/>
      <circle cx="260" cy="170" r="6" fill="#c8d8e8" stroke="#7a98b0" stroke-width="1.2"/>
      <line x1="210" y1="28" x2="210" y2="50" stroke="#7a98b0" stroke-width="0.8" stroke-dasharray="3,3"/>
      <line x1="260" y1="164" x2="252" y2="109" stroke="#7a98b0" stroke-width="0.8" stroke-dasharray="3,3"/>
    </svg>
  </div>
</div>
""", unsafe_allow_html=True)
...
<div class="card-grid">
  ...
  <div class="feat-card">
    <div class="feat-card-header">
      ...
      <div class="feat-title">Upload Data</div>
    </div>
    <div class="feat-desc">CSV / XLSX upload, Preview data, Missing value report, Duplicate removal.</div>
  </div>
  ...
  <div class="feat-card">
    ...
    <div class="feat-desc">Configure imputation, scaling, encoding. Split train/test (no data leakage).</div>
  </div>
  ...
  <div class="feat-card">
    ...
    <div class="feat-desc">Histograms, Box plots, Scatter plots, Heatmaps, Target analysis.</div>
  </div>
  ...
  <div class="feat-card">
    <div class="feat-card-header">
      ...
      <div class="feat-title">Train Model</div>
    </div>
    <div class="feat-desc">Choose algorithm, Tune hyperparameters, Run cross-validation.</div>
  </div>
  ...
  <div class="feat-card">
    <div class="feat-card-header">
      ...
      <div class="feat-title">Evaluate</div>
    </div>
    <div class="feat-desc">Confusion matrix, ROC curve, Feature importance, Full metrics.</div>
  </div>
